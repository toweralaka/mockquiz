...
class AccessCode(models.Model):
    ...
    freebie = models.BooleanField(
        default=False, 
        help_text='should card have freebie')
    ##special(customised)
    custom = models.BooleanField(default=False)
    ##special(customised) center requirement by buyer
    custom_center = models.CharField(
        max_length=1000, blank=True, null=True) 
    generated = models.DateTimeField(auto_now_add=True)
    buyer = models.CharField(max_length=30, blank=True, null=True)
...
class CardUse(models.Model):
    ...
    def __str__(self):
        return self.access_code.serial_number
